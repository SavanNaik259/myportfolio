...
<h2 className='text-capitalize text-white text-center text-lg-start'>step to built a successful digital product</h2>
...
<img src={socialimg} alt='portfolio img img-fluid' className='portfolio-img'/>
</div>
</div> 
</div>
 </div>
